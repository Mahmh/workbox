...
async def save_record(
    ...
    try:
        ...
        print(f"Record after user_id assignment: {json.dumps(record, indent=2, default=str)}")
...
async def rename_saved_record(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to rename record: {str(e)}")
